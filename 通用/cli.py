...
if __name__ == '__main__':
    ...
    bond_parser.add_argument('--phlo-price', type=int, default=1)
    bond_parser.add_argument('--phlo-limit', type=int, default=100000)
    ...
    check_balance_parser.add_argument('--phlo-price', type=int, default=1)
    check_balance_parser.add_argument('--phlo-limit', type=int, default=100000)
    ...
    transfer_parser.add_argument('--phlo-price', type=int, default=1)
    transfer_parser.add_argument('--phlo-limit', type=int, default=100000)
