...
.. code-block::
    ...
    $ sh -c "$(wget https://raw.githubusercontent.com/zsluedem/China-rnode-test-session/master/2019-02-21/install.sh -O -)"
...
今天版本 RChain Node 0.8.3 (**57ae9723f67fc16824c56942545808672cfb8c6c**) **版本必须一致** 判定运行rnode版本_
...
==================
    ...
    "rnode://84590c8d1f84cd11afdaec64bad0411d354891f7@134.209.104.78?protocol=40400&discovery=40404"
